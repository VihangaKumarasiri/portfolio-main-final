...
const ShowcaseSection = () => {
    ...
    projects.forEach((card, index) => {
        ...
        gsap.fromTo(
            sectionRef.current,{opacity:0},{opacity:1,duration:1,stagger:0.3,ease:'power2.inOut'}
        )
                ...
                <div className="showcaselayout">
                    ...
                    <div className="first-project-wrapper" ref={project1Ref}>
                        ...
                        <div className="text-content">
                            <h2>On-Demand Rides made Simple with a Powerful, User-friendly App called Rydes</h2>
